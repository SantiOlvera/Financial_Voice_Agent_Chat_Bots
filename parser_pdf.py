...
##get the array frome the anserw
...
# Expresión regular para encontrar los encabezados (coincidencias completas)
...
for i in stock:
    ...
    # Extract only the 'Open', 'Low', and 'Close' prices
...
##crear in txt de res2 y de stock.data.items()
## Poner un mensaje inicila de the news of todays market are the following
## poner un mensaje final de the stocks related to the news are the following
